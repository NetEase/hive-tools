...
public class MetaStoreUpdateService {

  public interface Iface {

    public TUpdateMetadataResponse updateMetadata(TUpdateMetadataRequest params) throws TException;

  }

  public interface AsyncIface {

    public void updateMetadata(TUpdateMetadataRequest params, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public TUpdateMetadataResponse updateMetadata(TUpdateMetadataRequest params) throws TException
    {
      send_updateMetadata(params);
      return recv_updateMetadata();
    }

    public void send_updateMetadata(TUpdateMetadataRequest params) throws TException
    {
    ...
    public TUpdateMetadataResponse recv_updateMetadata() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void updateMetadata(TUpdateMetadataRequest params, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      updateMetadata_call method_call = new updateMetadata_call(params, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class updateMetadata_call extends org.apache.thrift.async.TAsyncMethodCall {
      private TUpdateMetadataRequest params;
      public updateMetadata_call(TUpdateMetadataRequest params, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
      ...
      public TUpdateMetadataResponse getResult() throws TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class updateMetadata<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateMetadata_args> {
      ...
      public updateMetadata_result getResult(I iface, updateMetadata_args args) throws TException {
        updateMetadata_result result = new updateMetadata_result();
        result.success = iface.updateMetadata(args.params);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class updateMetadata<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateMetadata_args, TUpdateMetadataResponse> {
      public updateMetadata() {
        super("updateMetadata");
      }
      ...
      public AsyncMethodCallback<TUpdateMetadataResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<TUpdateMetadataResponse>() { 
          public void onComplete(TUpdateMetadataResponse o) {
            updateMetadata_result result = new updateMetadata_result();
            result.success = o;
            try {
      ...
      public void start(I iface, updateMetadata_args args, AsyncMethodCallback<TUpdateMetadataResponse> resultHandler) throws TException {
        iface.updateMetadata(args.params,resultHandler);
      }
    }
  ...
  public static class updateMetadata_args implements org.apache.thrift.TBase<updateMetadata_args, updateMetadata_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateMetadata_args>   {
    ...
    public TUpdateMetadataRequest params; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.PARAMS, new org.apache.thrift.meta_data.FieldMetaData("params", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TUpdateMetadataRequest.class)));
    ...
    public updateMetadata_args(updateMetadata_args other) {
      if (other.isSetParams()) {
        this.params = new TUpdateMetadataRequest(other.params);
      }
    }
    ...
    public TUpdateMetadataRequest getParams() {
      return this.params;
    }

    public updateMetadata_args setParams(TUpdateMetadataRequest params) {
      this.params = params;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PARAMS:
        if (value == null) {
          ...
          setParams((TUpdateMetadataRequest)value);
        }
        break;
    ...
    private static class updateMetadata_argsStandardScheme extends StandardScheme<updateMetadata_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, updateMetadata_args struct) throws TException {
          ...
          switch (schemeField.id) {
            case 1: // PARAMS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.params = new TUpdateMetadataRequest();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateMetadata_args struct) throws TException {
        struct.validate();
    ...
    private static class updateMetadata_argsTupleScheme extends TupleScheme<updateMetadata_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, updateMetadata_args struct) throws TException {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, updateMetadata_args struct) throws TException {
  ...
  public static class updateMetadata_result implements org.apache.thrift.TBase<updateMetadata_result, updateMetadata_result._Fields>, java.io.Serializable, Cloneable, Comparable<updateMetadata_result>   {
    ...
    public TUpdateMetadataResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TUpdateMetadataResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public updateMetadata_result(
      TUpdateMetadataResponse success)
    {
      this();
    ...
    public updateMetadata_result(updateMetadata_result other) {
      if (other.isSetSuccess()) {
        this.success = new TUpdateMetadataResponse(other.success);
      }
    }
    ...
    public TUpdateMetadataResponse getSuccess() {
      return this.success;
    }

    public updateMetadata_result setSuccess(TUpdateMetadataResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((TUpdateMetadataResponse)value);
        }
        break;
    ...
    private static class updateMetadata_resultStandardScheme extends StandardScheme<updateMetadata_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, updateMetadata_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new TUpdateMetadataResponse();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateMetadata_result struct) throws TException {
        struct.validate();
    ...
    private static class updateMetadata_resultTupleScheme extends TupleScheme<updateMetadata_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, updateMetadata_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, updateMetadata_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new TUpdateMetadataResponse();
