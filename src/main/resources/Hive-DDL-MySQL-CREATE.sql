...
--
-- Host: localhost    Database: hive_schema
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `hivecluster1` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `PARTITIONS` (
  ...
  `CREATE_TIME` int(11) NOT NULL,
  `LAST_ACCESS_TIME` int(11) NOT NULL,
  `PART_NAME` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `SD_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE `PARTITION_KEY_VALS` (
  `PART_ID` bigint(20) NOT NULL,
  `PART_KEY_VAL` varchar(256) CHARACTER SET utf8 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE `SDS` (
  ...
  `LOCATION` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
...
-- Dump completed on 2016-10-18 11:08:41
